...
export const notifclientmail = async (email, subject, object) => {
  try {
    ...
    <div style="background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        <h2 style="text-align: center; color: #4CAF50;">Notification de Réponse</h2>
        <p style="font-size: 1.1em;">Bonjour,</p>
        <p style="font-size: 1.1em;">Merci de bien vouloir attendre notre réponse de votre reclamation.</p>
